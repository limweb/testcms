...
import { withAuth, getAuth, getRootRoute } from '../services/auth'
import { ALL_ROLES } from '../util/constants'
...
export class Index extends Component {
  ...
  static async getInitialProps(ctx) {
    ...
    ctx.res.writeHead(302, { Location: rootPath })
    ctx.res.end()
  }
    ...
    return (
      <MainLayout {...this.props}>
        ...
        <div className="d-sm-flex align-items-center justify-content-between mb-4">
          <h1 className="h3 mb-0 text-gray-800" onClick={() => { this.setState({ count: this.state.count + 1 }) }}>Dashboard {this.state.count}</h1>
...
export default withAuth(Index, ALL_ROLES)
