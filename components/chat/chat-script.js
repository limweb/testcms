...
class ChatScript {
    ...
    openProfile(isJquery){

        console.log("Has class", $('body').hasClass('menu-active'))

        if (isJquery || !$('body').hasClass('menu-active')){
  ...
  ==========================*/
        ...
        /*=====================
               ...
               ==========================*/
        $('.menu-trigger, .close-profile, .open-profile').on('click', function (e) {
    ...
    initChat(){
        ...
        /*=====================
           25. Sticker
           ==========================*/
        $('.sticker-contain ul li').unbind()
        $('.sticker-contain ul li').on('click', function (e) {
            var sticker = $(this).children().html();

           
            if (self.onEnterMessage) {
                self.onEnterMessage({ text: sticker,type:messageType.STICKER,date:moment(new Date()).format("DD-MM-YYYY HH:mm:ss")}).then(response =>{
    ...
    newMessage() {
        ...
        $('#setemoj').val(null);
        if (self.onEnterMessage){
            self.onEnterMessage({ text: message, type: messageType.TEXT, date: moment(new Date()).format("DD-MM-YYYY HH:mm:ss")}).then(response =>{
    ...
    //     $(`<li class="sent"> 
    //     <div class="media"> 
    //     <div class="profile mr-4 bg-size" style="background-image: url(&quot;../../../static/chat/images/contact/2.jpg&quot;); background-size: cover; background-position: center center; display: block;"></div>
    ...
    //       </li>
    //       </ul> 
    //       </div></div></div></li>`).appendTo($('.messages .chatappend'));
