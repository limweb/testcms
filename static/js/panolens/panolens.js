(function (global, factory) {
	 ...
	 */
	function Infospot ( scale = 300, imageSrc, animated ) { //infospot construct
		...
		this.addEventListener( 'dbclick', this.onDoubleClick );
	...
	Infospot.prototype = Object.assign( Object.create( THREE.Sprite.prototype ), {
		...
		onContextMenu: function (event) {
			...
			if ( this.element && this.getContainer() ) {
				...
				if (this.handleOnRightClick) {
					this.handleOnRightClick(event, this)
				}
		...
		/**
	     * This will be called by a double click event
	     * Translate and lock the hovering element if any
	     * @param  {object} event - Event containing mouseEvent with clientX and clientY
	     * @memberOf Infospot
	     * @instance
	...
	function Panorama ( geometry, material ) {
		...
		// this.addEventListener('dbclick', this.onDoubleClick.bind( this ));
...
console.log('load by element');
	...
	Viewer.prototype = Object.assign( Object.create( THREE.EventDispatcher.prototype ), {
		...
		constructor: Viewer, //viewer constructor
